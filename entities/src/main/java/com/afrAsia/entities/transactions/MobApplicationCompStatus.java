 ...
 */
@Entity
@Table(name = "MOB_APPLICATION_COMP_STATUS")
@NamedQuery(name = "MobApplicationCompStatus.findAll", query = "SELECT m FROM MobApplicationCompStatus m")
public class MobApplicationCompStatus implements Serializable {
	...
	public MobApplicationCompStatus() {
	}
	...
	public String toString() {
		return "MobApplicationCompStatus [id=" + id + ", recordId=" + recordId + ", isAppLocked=" + isAppLocked
				+ ", lockedBy=" + lockedBy + ", kycDone=" + kycDone + ", kycStatus=" + kycStatus + ", kycComment="
				+ kycComment + ", kycUrl=" + kycUrl + ", kycDoneBy=" + kycDoneBy + ", kycDate=" + kycDate + ", wcDone="
				+ wcDone + ", wcStatus=" + wcStatus + ", wcComment=" + wcComment + ", wcUrl=" + wcUrl + ", wcDoneBy="
				+ wcDoneBy + ", wcDate=" + wcDate + ", ccDone=" + ccDone + ", ccStatus=" + ccStatus + ", ccComment="
				+ ccComment + ", ccUrl=" + ccUrl + ", ccDoneBy=" + ccDoneBy + ", ccDate=" + ccDate + ", icDone="
				+ icDone + ", icStatus=" + icStatus + ", icComment=" + icComment + ", icUrl=" + icUrl + ", icDoneBy="
				+ icDoneBy + ", icDate=" + icDate + ", compComment=" + compComment + ", compId=" + compId
				+ ", rmComment=" + rmComment + ", rmId=" + rmId + ", createdBy=" + createdBy + ", createdDate="
