 ...
 */
@Entity
@Table(name = "MOB_APPL_CHECK_HIST")
@NamedQuery(name = "MobApplCheckHist.findAll", query = "SELECT m FROM MobApplCheckHist m")
public class MobApplCheckHist implements Serializable {
	...
	public String toString() {
		return "MobApplCheckHist [recordId=" + recordId + ", isAppLocked=" + isAppLocked + ", lockedBy=" + lockedBy
				+ ", kycDone=" + kycDone + ", kycStatus=" + kycStatus + ", kycUrl=" + kycUrl + ", kycDoneBy="
				+ kycDoneBy + ", kycDate=" + kycDate + ", wcDone=" + wcDone + ", wcStatus=" + wcStatus + ", wcUrl="
				+ wcUrl + ", wcDoneBy=" + wcDoneBy + ", wcDate=" + wcDate + ", ccDone=" + ccDone + ", ccStatus="
				+ ccStatus + ", ccUrl=" + ccUrl + ", ccDoneBy=" + ccDoneBy + ", ccDate=" + ccDate + ", icDone=" + icDone
				+ ", icStatus=" + icStatus + ", icUrl=" + icUrl + ", icDoneBy=" + icDoneBy + ", icDate=" + icDate
