...
public class MobAccountAdditionalDetail implements Serializable {
	...
	public String toString() {
		return "MobAccountAdditionalDetail [id=" + id + ", authEmail1=" + authEmail1 + ", authEmail2=" + authEmail2
				...
				+ forexBanking + ", globalCustody=" + globalCustody + ", ibUsername=" + ibUsername
				+ ", internetBanking=" + internetBanking + ", modifiedBy=" + modifiedBy + ", modifiedDate="
				...
				+ ", nomineeName2=" + nomineeName2 + ", nomineeEmail1=" + nomineeEmail1 + ", nomineeEmail2="
				+ nomineeEmail2 + ", optCallbkServices=" + optCallbkServices + ", optTranEmail=" + optTranEmail
				+ ", otpEmail=" + otpEmail + ", otpSms=" + otpSms + ", pinViaPost=" + pinViaPost + ", pinViaSms="
				+ pinViaSms + ", prefCommMode=" + prefCommMode + ", prepaidCards=" + prepaidCards + ", recordId="
				+ recordId + ", stmtAddr1=" + stmtAddr1 + ", stmtAddr2=" + stmtAddr2 + ", stmtAddr3=" + stmtAddr3
				+ ", stmtCity=" + stmtCity + ", stmtCountry=" + stmtCountry + ", stmtDeliveryPo=" + stmtDeliveryPo
				+ ", stmtDeliveryEstmt=" + stmtDeliveryEstmt + ", requireChqBook=" + requireChqBook
				+ ", nomineeCc1=" + nomineeCc1 + ", nomineeCc2=" + nomineeCc2 + ", rmComment=" + rmComment + ", ibOption=" + ibOption
				+ "]";
	}
