...
/**
 * <p>Java class for Custjoint-Full-Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Custjoint-Full-Type">
 *   &lt;complexContent>
...
@XmlType(name = "Custjoint-Full-Type", propOrder = {
    "custno",
    "custjoint"
})
public class CustjointFullType {

    @XmlElement(name = "CUSTNO")
    protected String custno;
    @XmlElement(name = "Custjoint")
    protected List<CustjointFullType.Custjoint> custjoint;
     ...
     * {@link CustjointFullType.Custjoint }
     * 
     * 
     */
    public List<CustjointFullType.Custjoint> getCustjoint() {
        if (custjoint == null) {
            custjoint = new ArrayList<CustjointFullType.Custjoint>();
        }
