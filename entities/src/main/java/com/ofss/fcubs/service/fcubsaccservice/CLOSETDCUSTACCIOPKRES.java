 ...
 *                   &lt;element name="Cust-Account-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}TDCustAcc-Close-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "CLOSETDCUSTACC_IOPK_RES")
public class CLOSETDCUSTACCIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CLOSETDCUSTACCIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CLOSETDCUSTACCIOPKRES.FCUBSBODY }
     *     
     */
    public CLOSETDCUSTACCIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CLOSETDCUSTACCIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected TDCustAccCloseIOType custAccountIO;
         ...
         * @return
         *     possible object is
         *     {@link TDCustAccCloseIOType }
         *     
         */
        public TDCustAccCloseIOType getCustAccountIO() {
         ...
         *     
         */
        public void setCustAccountIO(TDCustAccCloseIOType value) {
