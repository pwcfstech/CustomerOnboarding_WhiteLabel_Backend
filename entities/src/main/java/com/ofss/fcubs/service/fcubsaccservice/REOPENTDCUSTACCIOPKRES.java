 ...
 *                   &lt;element name="Cust-Account-IO" type="{http://fcubs.ofss.com/service/FCUBSAccService}TDCustAcc-Reopen-IO-Type" minOccurs="0"/>
...
@XmlRootElement(name = "REOPENTDCUSTACC_IOPK_RES")
public class REOPENTDCUSTACCIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected REOPENTDCUSTACCIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link REOPENTDCUSTACCIOPKRES.FCUBSBODY }
     *     
     */
    public REOPENTDCUSTACCIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(REOPENTDCUSTACCIOPKRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        protected TDCustAccReopenIOType custAccountIO;
         ...
         * @return
         *     possible object is
         *     {@link TDCustAccReopenIOType }
         *     
         */
        public TDCustAccReopenIOType getCustAccountIO() {
         ...
         *     
         */
        public void setCustAccountIO(TDCustAccReopenIOType value) {
