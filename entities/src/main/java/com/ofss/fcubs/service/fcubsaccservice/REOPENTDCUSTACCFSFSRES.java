...
@XmlRootElement(name = "REOPENTDCUSTACC_FSFS_RES")
public class REOPENTDCUSTACCFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected REOPENTDCUSTACCFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link REOPENTDCUSTACCFSFSRES.FCUBSBODY }
     *     
     */
    public REOPENTDCUSTACCFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(REOPENTDCUSTACCFSFSRES.FCUBSBODY value) {
