...
@XmlRootElement(name = "CLOSETDCUSTACC_FSFS_RES")
public class CLOSETDCUSTACCFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CLOSETDCUSTACCFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CLOSETDCUSTACCFSFSRES.FCUBSBODY }
     *     
     */
    public CLOSETDCUSTACCFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CLOSETDCUSTACCFSFSRES.FCUBSBODY value) {
