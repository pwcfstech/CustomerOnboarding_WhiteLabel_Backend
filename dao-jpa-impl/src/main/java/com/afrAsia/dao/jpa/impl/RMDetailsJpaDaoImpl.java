...
public class RMDetailsJpaDaoImpl extends BaseJpaDAOImpl<String, RMDetails>implements RMDetailsJpaDAO {
	...
	public void updateRmDetails(RMDetails rmDetails) {
		...
		Query query = getEntityManager()
				.createQuery("update RMDetails rd set rd.rmName=:rmName,rd.rmEmailId=:rmEmailId,rd.rmMobNo=:rmMobNo,rd.userGroup=:userGroup,rd.modifiedBy=:modifiedBy,rd.modifiedDate=:modifiedDate " + "where rd.id =:id ");
		...
		query.setParameter("userGroup", rmDetails.getUserGroup());
